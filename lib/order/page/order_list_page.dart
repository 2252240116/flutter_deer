        ...
        child: Consumer<OrderPageProvider>(
          builder: (_, provider, child) {
            return CustomScrollView(
              /// 这里指定controller可以与外层NestedScrollView的【滚动分离】，避免一处滑动，5个Tab中的列表同步滑动。
              /// 这种方法的缺点是会重新layout列表
...
typedef callBack = Function(int, int);

String  Function(int, int)  loadName = (int riven,int jj){
  return "helllo$riven$jj";
};

String? getName(callBack loadName) {
  return loadName.call(1,2) as String;// 同上
}

typedef aaaaaa =  Widget Function(
